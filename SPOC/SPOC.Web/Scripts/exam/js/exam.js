    ...
    $j.ajax({
        ...
        success: function (data) {
            ...
            if (window.allowPasteCode) {
                loadScript("../monaco-editor/min_paste_on/vs/loader.js", function () {
                    require.config({ paths: { 'vs': '../monaco-editor/min_paste_on/vs' } });
                    ExamScriptManage.paperViewUtil.InitCodeEditor();
                });
            } else {
                loadScript("../monaco-editor/min/vs/loader.js", function () {
