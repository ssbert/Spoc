 ...
 xmlns:user="http://www.wrox.com.uuid">
  ...
  <msxsl:script language="javascript" implements-prefix="user">
    ...
    function ReplaceFillInContent(Content,questionUid,fileWebRootPath)
    {
      ...
      questionTextHtml=questionTextHtml+"<span id='spanLoadQuestionText"+questionUid+"' class='Nsb_exam_refresh' title='Reload casual working title' onclick=\"javascript:LoadQuestionText('"+questionUid+"')\">&nbsp;&nbsp;&nbsp;&nbsp;</span>";
    ...
    function AddPaperNodeToNavigator(paperNodeIndex,paperNodeName)
    {
      ...
      //生成表格头
      _navigatorHtml=_navigatorHtml+"<table width='242' border='0' cellspacing='1' cellpadding='0'>";
      ...
      <xsl:choose>
        <xsl:when test="$exam_do_mode_code='question'">
          <TABLE BORDER="0" cellpadding="0" cellspacing="0" style="margin-left:40px;margin-top:15px;">
                <Tr>
                    <td>
                        <input type="button" class="Nsb_exam_operate_btn" name="btnPreQuestion" id="btnPreQuestion"  onclick="GoToPreQuestion()"  value="Last topic"/></td>
                    <td>
                        &#160;&#160;&#160;&#160;</td>
                    <td>
                        <input type="button" class="Nsb_exam_operate_btn" name="btnNextQuestion" id="btnNextQuestion" onclick="GoToNextQuestion()"  value="Next question"/></td>
                </Tr>
            </TABLE>
        </xsl:when>
      </xsl:choose>
  ...
  <xsl:template name="exam_paper_node">
    ...
    <xsl:element name="div">
      ...
      <xsl:attribute name="title">Expansion/contraction</xsl:attribute>
      ...
      （Total<xsl:value-of select="question_num"></xsl:value-of>Question
      <xsl:if test="$is_show_score='Y'">
			  <xsl:if test="question_score>0">
          ，Each question<xsl:value-of select="question_score"></xsl:value-of>Minute
        </xsl:if>
        ，Total<xsl:value-of select="total_score"></xsl:value-of>Minute
      </xsl:if>
		  ）
      ...
      <TR class="Nsb_exam_sttitle_small" id='panelQuestionText_'>
		  <xsl:element name="td">
			  ...
			  <xsl:element name="span">
				...
				<xsl:attribute name="title">Note/Unmark</xsl:attribute>
			  ...
			  <xsl:if test="$is_show_score='Y'">
				（<xsl:value-of select="paper_question_score"></xsl:value-of> Minute）
        </xsl:if>
			  <xsl:choose>
        ...
        <TD>
          ...
          <xsl:choose>
            ...
            <xsl:when test="question_base_type_code='judge_correct'">
              ...
              <br />If it's wrong, please correct it:
            ...
            <xsl:when test="question_base_type_code='answer'">
			  ...
			  <xsl:when test="$exam_is_only_upload_file='Y' and is_answer_by_html='Y' and is_only_upload_file!='N'">
				  ...
				  <xsl:element name="input">
					...
					<xsl:attribute name="value">Post attachments</xsl:attribute>
			  ...
			  <xsl:otherwise>
				  ...
				  <xsl:if test="is_answer_by_html='Y'">
					  <xsl:element name="input">
						  <xsl:attribute name="type">button</xsl:attribute>
						  <xsl:attribute name="value">Advance Editor</xsl:attribute>
            ...
            <xsl:when test="question_base_type_code='operate'">
              ...
              <xsl:element name="input">
                <xsl:attribute name="type">button</xsl:attribute>
                <xsl:attribute name="value">Begin to operate</xsl:attribute>
			...
			<xsl:when test="question_base_type_code='voice'">
              ...
              <xsl:element name="input">
                <xsl:attribute name="type">button</xsl:attribute>
                <xsl:attribute name="value">Begin to answer</xsl:attribute>
            ...
            <xsl:when test="question_base_type_code='typing'">
              ...
              <xsl:element name="input">
                <xsl:attribute name="type">button</xsl:attribute>
                <xsl:attribute name="value">Begin typing</xsl:attribute>
