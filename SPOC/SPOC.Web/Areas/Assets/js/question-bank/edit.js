...
var NormalQuestion = (function() {
    ...
    function init(id, parentId) {
                ...
                function (data) {
                    ...
                    if (data.success) {
                        if (data.result.code === 0) {
                            ...
                            //$("#run-result").textbox("setValue", "输出:" + data.result.result);
        ...
        function getFormParam() {
            ...
            } else if (param.questionBaseTypeCode === "fill") {
        ...
        function fillForm(data) {
            ...
            } else if (data.questionBaseTypeCode === "fill") {
        ...
        function createOption(index, value, type) {
            ...
            <div><input type="{2}" name="option" value="{3}">&nbsp;&nbsp;{0}：</div>\
            <div style="line-hight:20px;"><a id="option-delete-btn-{3}" href="javascript:void(0)" class="easyui-linkbutton" onclick="edit.onDeleteOption({3})" iconCls="icon-busy" title="删除" plain="true">删除</a></div>\
            </label>\
