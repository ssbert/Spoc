...
student.prototype = {
            ...
            onSelect: function (item) {
                ...
                $('#user_majorid').combobox({
                    onSelect: function (data) {
                        var url = '/api/services/app/Department/CmbAdministrativeClass?majorId=' + data.id;
                        $('#administrative_classid').combobox('clear');
                        $('#administrative_classid').combobox('reload', url);
    ...
    formBind: function (row) {
        ...
        $('#fm').form('load', row);
        //行政班级
        setTimeout(function () { $('#administrative_classid').combobox('setValue', row.user_administrativeclassid);   }, 300);
        $('#user_classid').combotree('setValue', row.user_classid); 
