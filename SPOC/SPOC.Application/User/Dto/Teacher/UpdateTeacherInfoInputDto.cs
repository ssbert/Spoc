...
{
    public class UpdateTeacherInfoInputDto : EntityDto<Guid>
    {
        ...
        public void SetTeacherInfo(ref TeacherInfo model) { 
        
             //   model.id = this.id;
                model.userId = this.user_id;
                model.teacherCode = this.teacherCode;
                model.teacherTitle = this.teacherTitleCreate;
                model.teacherJobStatusCode = this.teacherJobStatusCode;
                model.teacherProfessionalDirection = this.teacherProfessionalDirection;
                model.teacherEntryDate = this.teacherEntryDate;
                model.teacherStartworkDate = this.teacherStartworkDate;
                model.teacherEduAge = this.teacherEduAge;
                model.teacherEducation = this.teacherEducation;
                model.teacherAcademicDegree = this.teacherAcademicDegree;
                model.teacherGraduateSchool = this.teacherGraduateSchool;
                model.teacherGraduateDate = this.teacherGraduateDate;
                model.teacherStudyProfessional = this.teacherStudyProfessional;
                model.teacherIsAddCourse = this.teacherIsAddCourse;
                model.teacherPersonalResume = this.teacherPersonalResume;
                model.isDel = this.isDel;
                model.teacherEnbleFlag = this.teacherEnbleFlag;
